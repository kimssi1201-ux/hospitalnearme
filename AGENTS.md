...
Run `npm.cmd run check` before committing. For UI changes, also open the site at desktop and mobile widths and verify navigation, article links, API loading states, and empty/error states manually.
